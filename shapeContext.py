...
def get_points_from_img(src,treshold=50,simpleto=100,t=CANNY):
    ...
    if isinstance(src,str):  
        src=cv2.imread(src,cv2.CV_LOAD_IMAGE_GRAYSCALE);     #Load as grayscale image
...
if __name__ == '__main__':
    ...
    points1 = get_points_from_img('B.png',simpleto=sampls)
    points2 = get_points_from_img('D.png',simpleto=sampls)
    P = a.compute(points1)
    print P
    Q = a.compute(points2)
    print "============================================  DONE ================================================"
